...
int omw::windows::ErrorCode::code() const { return errorCode; }

//! @brief Getter for the message.
//! @return  Message string
const std::string& omw::windows::ErrorCode::msg() const { return errorMsg; }

//! @brief
//! @return  `true` if `code() == omw::windows::EC_OK`
//!
bool omw::windows::ErrorCode::good() const { return (code() == omw::windows::EC_OK); }

std::string omw::windows::ErrorCode::toString() const { return std::to_string(code()) + OMWi_DISPSTR(" - ") + msg(); }
