...
TEST_CASE("ansi-esc.h ANSI ESC mode and sequence builder")
{
    // check initial state
...
TEST_CASE("ansi-esc.h CSI sequence biulders")
{
...
TEST_CASE("ansi-esc.h CSI Sequence Types")
{
...
TEST_CASE("ansi-esc.h SGR sequence biulders")
{
...
TEST_CASE("ansi-esc.h SGR parameters and arguments")
{
