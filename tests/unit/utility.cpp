...
TEST_CASE("utility.h shiftLeftAssign() 64-bit")
{
    ...
    ir = 0x8000000000000001;
    UTILITY_CHECK_SHIFTLEFTASSIGN_S();
    iv = 0x4000000000000001;
    ir = 0x4000000000000001;
    UTILITY_CHECK_SHIFTLEFTASSIGN_S();
    ...
    n = 0;
    uiv = 0x8000000000000001;
    uir = 0x8000000000000001;
    UTILITY_CHECK_SHIFTLEFTASSIGN_U();
    uiv = 0x4000000000000001;
    uir = 0x4000000000000001;
    UTILITY_CHECK_SHIFTLEFTASSIGN_U();

    n = 2;
    uiv = 0x8000000000000001;
    uir = 0x0000000000000004;
    UTILITY_CHECK_SHIFTLEFTASSIGN_U();
    uiv = 0x4000000000000001;
    uir = 0x0000000000000004;
    UTILITY_CHECK_SHIFTLEFTASSIGN_U();
...
TEST_CASE("utility.h shiftRightAssign() 64-bit")
{
    ...
    n = 2;
    iv = 0x8000000000000001;
    ir = 0xE000000000000000;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_S();
    iv = 0x4000000000000001;
    ir = 0x1000000000000000;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_S();

    n = 62;
    iv = 0x8000000000000001;
    ir = 0xFFFFFFFFFFFFFFFE;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_S();
    iv = 0x4000000000000001;
    ir = 0x0000000000000001;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_S();

    n = 63;
    iv = 0x8000000000000001;
    ir = 0xFFFFFFFFFFFFFFFF;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_S();
    iv = 0x4000000000000001;
    ir = 0x0000000000000000;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_S();
    ...
    n = 2;
    uiv = 0x8000000000000001;
    uir = 0x2000000000000000;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_U();
    uiv = 0x4000000000000001;
    uir = 0x1000000000000000;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_U();

    n = 62;
    uiv = 0x8000000000000001;
    uir = 0x0000000000000002;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_U();
    uiv = 0x4000000000000001;
    uir = 0x0000000000000001;
    UTILITY_CHECK_SHIFTRIGHTASSIGN_U();
