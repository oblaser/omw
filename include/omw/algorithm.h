...
/// @{
template <typename T> inline size_t levenshteinDistance(const T* a, size_t aCount, const T* b, size_t bCount)
{
    size_t r;
...
template <typename T> inline size_t levenshteinDistance(const std::vector<T>& a, const std::vector<T>& b)
{
    size_t r;
